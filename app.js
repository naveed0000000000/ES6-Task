...
// // Observation: Only `var` is added to the global `window` object.
...
// // Observation: Variables declared inside a function are not accessible outside.
...
// // Observation: `var` does not follow block scope, while `let` and `const` do.

// // Question 4: Hoisting with var
// console.log(hoistedVar); // undefined
// var hoistedVar = "I am hoisted";

// // Observation: `var` variables are hoisted and initialized as `undefined`.
...
// // Observation: `let` and `const` are hoisted but not initialized, causing a ReferenceError if accessed before declaration.

// // Question 6: Re-declaration
// // Using var
// var redeclareVar = "First declaration";
// var redeclareVar = "Second declaration"; // No error
...
// try {
//     const redeclareConst = "Second declaration"; // SyntaxError
// } catch (error) {
//     console.error(error);
// }

// // Observation: `var` allows re-declaration, but `let` and `const` throw errors.

// // Question 7: Re-assignment
// // Using var
// var reassignVar = "Initial value";
// reassignVar = "New value"; // Allowed
// console.log(reassignVar); // "New value"

// // Using let
// let reassignLet = "Initial value";
// reassignLet = "New value"; // Allowed
// console.log(reassignLet); // "New value"

// // Using const
// const reassignConst = "Initial value";
// try {
//     reassignConst = "New value"; // TypeError
// } catch (error) {
//     console.error(error);
// }

// // Observation: `var` and `let` allow re-assignment, but `const` does not.

// // Question 8: Temporal Dead Zone (TDZ)
// try {
...
// // Observation: Variables declared with `let` and `const` are in the TDZ until their declaration is reached.

// // Question 9: When to use var, let, and const
// // Use `var` for compatibility with older code or global properties
